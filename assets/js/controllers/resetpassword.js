app.controller('resetpasswordController', ['$scope', "$interval", 'hrmAPIservice','$routeParams',function ($scope, $interval, hrmAPIservice, $routeParams) {
    $scope.showMessage = 0;
    $scope.reset= {};
    $scope.showHeader = 0;
    $scope.isLoggedin = 0;
    ...
    $scope.doResetPassword = function() {
        ...
        hrmAPIservice.resetPassword($scope.reset.username,$scope.reset.password).then(function(response) {
            ...
            $scope.userProgressMessage = "";
            if($scope.success){
                var promise = $interval(doCountDown, 1000);
            }
        });
    }
    ...
    $scope.usePassword = function(){
        $scope.reset.password = $scope.passwordInput;
        $scope.reset.confirmpassword = $scope.passwordInput;
        $scope.copied = 0;
        $scope.showModalVariable = false;
    }
    ...
    $scope.checkpasswordStength = function(e, pw) {
        ...
        $scope.complexify({minimumChars:6, strengthScaleFactor:0.7, pw: pw}, function(valid, complexity) {
            ...
            $scope.userProgressPercent = per_num;
            // // // // //
    	});
    }
