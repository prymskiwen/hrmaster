...
$today = date("Y-m-d");      
$courses_table = new db("courses");
$courses_table->update(array('status'=>':status'), 'is_auto_inactive=1 AND auto_inactive_time='.$today.' AND deleted=0', false, array(':status'=>0));
?>